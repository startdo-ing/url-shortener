/**
 * Design tokens generated from design.md (Notion Beige theme).
 * To change the visual language, edit design.md and update this file to match.
 * Use CSS custom properties (var(--...)) in component styles to stay in sync.
 */
...
:root {
  ...
  --color-success-bg: #d4f0e8;
  --color-success-fg: #1a6048;
  --color-warning-bg: #fef6e4;
  --color-warning-fg: #7a5c1a;
  --color-danger-bg: #fdf0ee;
  --color-danger-fg: #8b3a2e;
  --color-danger-border: #e8c0b9;
  --color-muted-bg: #ede9e4;
}
...
.radio-group label:has(:checked) {
  background: color-mix(in srgb, var(--color-tertiary) 15%, var(--color-surface));
  color: var(--color-tertiary);
  border-color: color-mix(in srgb, var(--color-tertiary) 40%, transparent);
}

.radio-group label:has(:checked)::before {
  content: "✓";
  font-size: 0.65em;
  font-weight: 700;
  margin-right: 4px;
...
.radio-group label:hover:not(:has(:checked)) {
...
.badge--disabled { background: var(--color-muted-bg); color: var(--color-secondary); }
.badge--pending  { background: var(--color-warning-bg); color: var(--color-warning-fg); }
.badge--verified { background: var(--color-success-bg); color: var(--color-success-fg); }
.badge--failed   { background: var(--color-danger-bg); color: var(--color-danger-fg); }
.badge--primary  { background: color-mix(in srgb, var(--color-tertiary) 15%, var(--color-surface)); color: var(--color-tertiary); }
